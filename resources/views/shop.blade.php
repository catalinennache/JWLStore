            ...
            <div class="row">
              <div class="col-md-12 text-center">
                <div class="site-block-27">
                  <ul>
                    @if($active_tab > 0)  <li><a href="#">&lt;</a></li> @endif
                    <?php  
                          for($i = 0; $i<$pages; $i++){
                    ?>
                    @if($i == $active_tab)
                    ...
                    @else
                          <li><a href="shop?page={{$i+1}}">{{$i+1}}</a></li>
                    @endif
                    @if($active_tab != $pages-1) <li><a href="#">&gt;</a></li> @endif
            ...
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
               <?php foreach ($cats as $cat=>$pcs) { ?>
                <li class="mb-1"><a href="#" class="d-flex"><span>{{$cat}}</span> <span class="text-black ml-auto">({{$pcs}})</span></a></li>
               <?php }?>
              </ul>
            </div>
