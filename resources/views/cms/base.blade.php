  ...
  <body class="staged">
   ...
   document.body.appendChild(script);
      ...
      <div class="nav-bar">
        <ul>
          <li>
            <a href="/admin/?section=produse">  Produse </a>
          </li>

          <li>
              <a href="/admin/?section=comenzi">    Comenzi
              </a>   </li>

          <li>
              <a href="/admin/?section=plati">
              Plati
              </a>
          </li>

          <li>
              <a href="/admin/?section=useri">
              Useri
              </a>
          </li>

          <li> 
              <a href="/admin/?section=colectii">
              Colectii
              </a>
          </li>
          <li> 
